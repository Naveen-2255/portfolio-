...
export default function CodingProfiles() {
  ...
  return (
    <section id="profiles" className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      ...
      <div className="w-full bg-[#0d1117] border border-slate-800 rounded-2xl p-6 md:p-8 shadow-2xl overflow-hidden relative">
        {/* Glow effect */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-32 bg-emerald-500/10 blur-[100px] pointer-events-none"></div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4 relative z-10">
          ...
          <div className="px-4 py-2 bg-slate-800/50 rounded-full border border-slate-700/50 text-emerald-400 text-xs font-medium backdrop-blur-sm">
            @naveenjoseph
          </div>
        </div>
        ...
        <div className="mt-4 flex items-center justify-between text-xs text-slate-400 relative z-10">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-[3px]">
              ...
              <div className="w-[11px] h-[11px] sm:w-[13px] sm:h-[13px] rounded-[2px] bg-emerald-900/60"></div>
              <div className="w-[11px] h-[11px] sm:w-[13px] sm:h-[13px] rounded-[2px] bg-emerald-700/80"></div>
              <div className="w-[11px] h-[11px] sm:w-[13px] sm:h-[13px] rounded-[2px] bg-emerald-500"></div>
              <div className="w-[11px] h-[11px] sm:w-[13px] sm:h-[13px] rounded-[2px] bg-emerald-400"></div>
            </div>
            <span>More</span>
          </div>
        </div>
